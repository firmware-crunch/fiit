...
from ..emu_types import MemoryRegion
...
class ArmPl190:
    ...
    def __init__(
        ...
        base_address: int,
        auto_map: bool = True,
        daisy_chain: Optional['ArmPl190'] = None
    ):
        self.uc = uc
        ...
        self._daisy_chain: Optional['ArmPl190'] = daisy_chain
        ...
        # Logger
        ########################################################################
        self._logger = logging.getLogger('fiit.arm_pl190')
