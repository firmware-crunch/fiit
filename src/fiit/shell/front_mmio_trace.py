...
from ..mmio_trace import MmioTrace, MmioTraceViz


@IPython.core.magic.magics_class
class MmioTraceViz(IPython.core.magic.Magics):
    def __init__(self, mmio_tracer: MmioTrace, shell: Shell):
        self._mmio_mon = mmio_tracer
        self._trace_viz = MmioTraceViz(self._mmio_mon.mmio_data_trace)
        super(MmioTraceViz, self).__init__(shell=shell.shell)
        self._shell = shell
        self._shell.register_magics(self)
        self._shell.register_aliases(self)

    @IPython.core.magic.line_magic
    def mmio_access_count(self, _: str):
    ...
    def mmio_access_stats(self, line: str):
        ...
        print(self._trace_viz.mmio_access_stats_to_str(multi_bar))
    ...
    def mmio_access_timeline(self, line: str):
        ...
        print(self._trace_viz.mmio_access_timeline_to_str(**kwargs))

    @IPython.core.magic.line_magic
    def mmio_access_locations_info(self, _: str):
    ...
    @IPython.core.magic.line_magic
    def mmio_access_locations_count(self, _: str):
