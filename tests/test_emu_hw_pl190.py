...
from unicorn.unicorn_const import UC_ARCH_ARM, UC_MODE_ARM, UC_MODE_LITTLE_ENDIAN

from fiit.emu.hw.pl190 import ArmPl190, Pl190Exception
...
class BaseTestArmPl190(MmioReadPrimitive):
    def setup_method(self, test_method):
        ...
        self.vic = ArmPl190(self.uc, VIC_0_BASE)
        self.vic.reset()
...
class TestArmPl190(BaseTestArmPl190):
    def test_fiq(self):
        int_line_nb = 8
...
class BaseTestArmPl190DaisyChain(MmioReadPrimitive):
    def setup_method(self, test_method):
        self.uc = Uc(UC_ARCH_ARM, UC_MODE_ARM | UC_MODE_LITTLE_ENDIAN)

        self.vic0 = ArmPl190(self.uc, VIC_0_BASE)
        ...
        self.vic1 = ArmPl190(self.uc, VIC_1_BASE, daisy_chain=self.vic0)
...
class TestArmPl190DaisyChain(BaseTestArmPl190DaisyChain):
