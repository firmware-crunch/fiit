...
class BinBlob2Dbg:
    def __init__(self, bin_blob: Type[MetaBinBlob], **kargs):
        ...
        self.dbg = Debugger(self.emu.uc, **kargs)
...
def test_segfault_fetch():
    def debug_callback(dbg: Debugger, event_id: int, args: dict):
...
class TestBreakpoint:
    def bp_callback(self, dbg: Debugger, event_id: int, args: dict):
...
def test_complete_dump_register():
...
def test_partial_dump_register():
